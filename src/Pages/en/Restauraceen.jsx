...
<div className="paragraph">The restaurant is open daily for our guests until <div className="strong">10pm</div>. Throughout the day you can choose dishes from our menu.</div>

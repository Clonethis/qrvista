...
<div className="paragraph">Restaurace je pro naše hosty otevřena denně do <div className="strong">22:00</div>. V průběhu celého dne si můžete vybrat pokrmy z našeho jídelního lístku. </div>

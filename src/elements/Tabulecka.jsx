...
Specifikace prostorů
            ...
            <tbody><tr className="first">
                ...
                <th className="upper"><span class="icon icon-meeting"></span> U</th>
                <th className="upper"><span class="icon icon-meeting-o"><MdGroups/></span> Ženeva</th>
            </tr>
            <tr>
                <th>Velký sál</th>
                ...
                <td>60</td>
                <td>60</td>
                {/* <td><a class="conference-gallery" data-gallery="13" href="/cs/fotogalerie">GALERIE</a></td> */}
            </tr>
            <tr>
                <th>Sál A</th>
                ...
                <td>25</td>
                <td>30</td>
                {/* <td><a class="conference-gallery" data-gallery="14" href="/cs/fotogalerie">GALERIE</a></td> */}
            </tr>
            <tr>
                <th>Sál B</th>
                <td>60 m<sup>2</sup></td>
                ...
                <td>25</td>
                <td>30</td>
                {/* <td><a class="conference-gallery" data-gallery="15" href="/cs/fotogalerie">GALERIE</a></td> */}
            </tr>
            <tr>
                <th>Revista</th>
                ...
                <td>35</td>
                <td>40</td>
                {/* <td><a class="conference-gallery" data-gallery="12" href="/cs/fotogalerie">GALERIE</a></td> */}
            </tr>
            <tr>
                <th>Salónek 1</th>
                ...
                <td>10</td>
                <td>12</td>
                {/* <td><a class="conference-gallery" data-gallery="10" href="/cs/fotogalerie">GALERIE</a></td> */}
            </tr>
            <tr>
                <th>Salónek 2</th>
                <td>21 m<sup>2</sup></td>
